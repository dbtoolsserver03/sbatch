...
package jp.co.saisk._17_job_stop_sign;
...
public class SignJobStopJob {
	...
	public static void main(String[] args) {
		...
		System.exit(SpringApplication.exit(SpringApplication.run(SignJobStopJob.class, args)));
	}
	...
	public Tasklet tasklet1() {
		return new Tasklet() {
			...
			public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
				...
				//其中的StepExecution#setTerminateOnly() 
				// 给运行中的stepExecution设置停止标记，
				// Spring Batch 识别后直接停止步骤，进而停止流程
	...
	public Job job() throws Exception {
		return new JobBuilder("sign-step-stop-job02", jobRepository) // 创建一个 Job 构建器
				//	.preventRestart()  //禁止重启
