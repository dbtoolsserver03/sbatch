package jp.co.saisk._07_tasklet_simple;
...
public class SimpleTaskletJobApplication {
	...
	public static void main(String[] args) {
		...
		System.exit(SpringApplication.exit(SpringApplication.run(SimpleTaskletJobApplication.class, args)));
	}
	...
	public Job job() throws Exception {
		return new JobBuilder("simple-tasklet-job", jobRepository) // 创建一个 Job 构建器
				.start(step1())
