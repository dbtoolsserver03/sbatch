package jp.co.saisk._25_itemreader_db_page;
...
public class PageDBReaderJob {
	...
	public static void main(String[] args) {
		...
		System.exit(SpringApplication.exit(SpringApplication.run(PageDBReaderJob.class, args)));
	}
	...
	public Job job() throws Exception {
		return new JobBuilder("page-db-reader-job02", jobRepository) // 创建一个 Job 构建器
				.start(step())
				.build();
	}
