package jp.co.saisk._21_itemreader_flat;
...
public class FlatReaderJob {
	...
	public static void main(String[] args) {
		...
		System.exit(SpringApplication.exit(SpringApplication.run(FlatReaderJob.class, args)));
	}
	...
	public Job job() throws Exception {
		return new JobBuilder("flat-reader-job", jobRepository) // 创建一个 Job 构建器
