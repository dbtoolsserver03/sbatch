package jp.co.saisk._23_itemreader_flat_json;
...
public class JsonFlatReaderJob {
	...
	public static void main(String[] args) {
		...
		System.exit(SpringApplication.exit(SpringApplication.run(JsonFlatReaderJob.class, args)));
	}
	...
	public Job job() throws Exception {
		return new JobBuilder("json-flat-reader-job", jobRepository) // 创建一个 Job 构建器
