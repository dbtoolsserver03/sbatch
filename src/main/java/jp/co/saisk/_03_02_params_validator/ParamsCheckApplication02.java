package jp.co.saisk._03_02_params_validator;
...
public class ParamsCheckApplication02 {
	...
	public static void main(String[] args) {
        ...
        System.exit(SpringApplication.exit(SpringApplication.run(ParamsCheckApplication02.class, args)));
    }
    ...
    public Job importUserJob(JobRepository jobRepository, Step step1) throws Exception {
        return new JobBuilder("ParamsCheckApplication02", jobRepository)  // 创建一个 Job 构建器
	...
	public Step step1(JobRepository jobRepository, JdbcTransactionManager transactionManager) {
		return new StepBuilder("step3", jobRepository).tasklet(tasklet1(null),transactionManager).build();
	}
