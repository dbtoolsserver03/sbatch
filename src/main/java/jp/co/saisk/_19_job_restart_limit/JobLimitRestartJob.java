...
package jp.co.saisk._19_job_restart_limit;
...
public class JobLimitRestartJob {
	...
	public static void main(String[] args) {
		...
		System.exit(SpringApplication.exit(SpringApplication.run(JobLimitRestartJob.class, args)));
	}
	...
	public Job job() throws Exception {
		return new JobBuilder("job-restart-limit-job", jobRepository) // 创建一个 Job 构建器
