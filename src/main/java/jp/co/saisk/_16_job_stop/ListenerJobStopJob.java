...
package jp.co.saisk._16_job_stop;
...
public class ListenerJobStopJob {
	...
	public static void main(String[] args) {
		...
		System.exit(SpringApplication.exit(SpringApplication.run(ListenerJobStopJob.class, args)));
	}
	...
	public Job job() throws Exception {
		return new JobBuilder("step-stop-job", jobRepository) // 创建一个 Job 构建器
