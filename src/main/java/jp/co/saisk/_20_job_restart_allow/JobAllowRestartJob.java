...
package jp.co.saisk._20_job_restart_allow;
...
public class JobAllowRestartJob {
	...
	public static void main(String[] args) {
		...
		System.exit(SpringApplication.exit(SpringApplication.run(JobAllowRestartJob.class, args)));
	}
	...
	public Job job() throws Exception {
		return new JobBuilder("job-allow-restart-job", jobRepository) // 创建一个 Job 构建器
	...
	public Step step1() {
		return new StepBuilder("step1", jobRepository)
				...
				// 可以通过步骤的allowStartIfComplete(true) 实现步骤的无限重启。
