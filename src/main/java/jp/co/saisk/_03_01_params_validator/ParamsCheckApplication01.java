package jp.co.saisk._03_01_params_validator;
...
public class ParamsCheckApplication01 {
	...
	public static void main(String[] args) {
        ...
        System.exit(SpringApplication.exit(SpringApplication.run(ParamsCheckApplication01.class, args)));
    }
    ...
    public Job importUserJob(JobRepository jobRepository, Step step1) throws Exception {
        return new JobBuilder("ParamsCheckApplication01", jobRepository)  // 创建一个 Job 构建器
