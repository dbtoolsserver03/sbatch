package jp.co.saisk._09_step_listener;
...
public class StepListenerJobApplication {
	...
	public static void main(String[] args) {
		...
		System.exit(SpringApplication.exit(SpringApplication.run(StepListenerJobApplication.class, args)));
	}
	...
	public Job job() throws Exception {
		return new JobBuilder("step-tasklet-job", jobRepository) // 创建一个 Job 构建器
				.start(step1())
