...
public class ParamsIncrApplication01 {
	...
	public static void main(String[] args) {
		...
		System.exit(SpringApplication.exit(SpringApplication.run(ParamsIncrApplication01.class, args)));
	}
	...
	public Job importUserJob(JobRepository jobRepository, Step step1) throws Exception {
		return new JobBuilder("ParamsCheckApplication03", jobRepository) // 创建一个 Job 构建器
	...
	public Step step1(JobRepository jobRepository, JdbcTransactionManager transactionManager) {
		return new StepBuilder("step1", jobRepository).tasklet((contribution, chunkContext) -> {
			...
			System.out.println("ParamsIncrApplication01! step1");
